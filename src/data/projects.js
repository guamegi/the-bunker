export const projects = [
  {
    no: 13,
    name: "Mind Mirror Landing Page",
    period: "2026.04",
    images: [
      "src/images/projects/mindMirrorLandingPage/1.png",
      "src/images/projects/mindMirrorLandingPage/2.png",
      "src/images/projects/mindMirrorLandingPage/3.png",
      "src/images/projects/mindMirrorLandingPage/4.png",
      "src/images/projects/mindMirrorLandingPage/5.png",
      "src/images/projects/mindMirrorLandingPage/6.png",
    ],
    desc: `Mind Mirror 랜딩페이지는 AI 심리 분석 다이어리 서비스의 핵심 가치와 주요 기능을 한눈에 전달하기 위해 제작한 웹사이트. 서비스 소개, 감정 분석 방식, AI 대화 일기, 사진 기반 일기, 다운로드 유도까지 하나의 흐름으로 구성해 사용자 이해와 전환을 강화.`,
